...
QT_MOC_LITERAL(1, 11, 10), // "gamePicked"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 5) // "index"

    },
    "BlurPicker\0gamePicked\0\0index"
};
...
void BlurPicker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->gamePicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (BlurPicker::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BlurPicker::gamePicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject BlurPicker::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_BlurPicker.data,
      qt_meta_data_BlurPicker,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void BlurPicker::gamePicked(int _t1)
{
